;(() => {
  ...
  if (reasonRaw) {
    ...
    if (decoded.includes("GEMINI_HIGH_RISK")) {
      ...
      detailMessages.push(
        "🤖 AI 분석 결과 위험도 HIGH RISK입니다.\n\n고급 AI 분석을 통해 이 사이트가 피싱, 사기, 또는 악성 활동에 사용될 가능성이 높다고 판단되었습니다. 해당 사이트는 사용자의 개인정보를 탈취하거나 금융 정보를 빼내기 위해 정교하게 위장된 페이지일 수 있으며, 악성코드 배포, 불법 도박, 불법 성인 콘텐츠 제공 등의 목적으로 운영될 가능성이 있습니다. URL 구조, 도메인 이름 패턴, 콘텐츠 분석 결과를 종합하여 신뢰할 수 없는 사이트로 분류되었습니다. 안전을 위해 접속을 중단하고 공식 사이트를 이용하시기 바랍니다.",
      )
      isGlobalBlocked = true
    }
